...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyPlot_t, stringdata) + ofs \
...
const QMetaObject MyPlot::staticMetaObject = {
    { &QCustomPlot::staticMetaObject, qt_meta_stringdata_MyPlot.data,
      qt_meta_data_MyPlot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyPlot.stringdata))
